...
model_Stage2_K1 = dict(
    ...
    tpv_aggregator=dict(
        ...
        tpv_z=16,
        type='TPVAggregator_Seg'),
    tpv_encoder_decoder=dict(base_channel=256, type='UNet_Stage2_K1'),
...
model_Stage2_K3 = dict(
    ...
    tpv_aggregator=dict(
        ...
        tpv_z=16,
        type='TPVAggregator_Seg'),
    tpv_encoder_decoder=dict(base_channel=256, type='UNet_Stage2_K3'),
...
test_data_loader = dict(
    batch_size=1,
    data_path_rain15='/home/yxy/datasets/AdverseNet/test',
    fix_sample=1000,
    num_workers=1,
    shuffle=False)
tpv_h_ = 180
