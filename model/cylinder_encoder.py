...
class CylinderEncoder_Seg(BaseModule):
    def __init__(self, grid_size, grid_size_rv=None, in_channels=9, out_channels=256, 
                 fea_compre=16, base_channels=32, split=[4,4,4], track_running_stats=True):

        super(CylinderEncoder_Seg, self).__init__()
        
        self.fea_compre = fea_compre # none
        self.grid_size = grid_size # [480, 360, 32]
        self.split = split # [16,16,16]
        ...
        self.point_mlp = nn.Sequential( 
            ...
            nn.BatchNorm1d(in_channels, track_running_stats=track_running_stats), # 9
            ...
            nn.Linear(256, out_channels) # 256
        )
